...
import { Github, ExternalLink, Mail, MapPin, ArrowDownToLine } from 'lucide-react';
        ...
        <div className="text-center">
          ...
          <div className="flex flex-wrap justify-center gap-4 mb-8 animate-fade-in delay-700">
            <Link
              ...
              className="flex items-center gap-2 text-gray-300 bg-slate-800/50 px-4 py-2 rounded-full border border-cyan-500/20">
            ...
            <Link
              ...
              <ArrowDownToLine className="w-5 h-5 text-fuchsia-400" />
